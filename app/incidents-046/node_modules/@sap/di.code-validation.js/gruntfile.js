...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        mochaTest: {
            test: {
                options: {
                    ...
                    reporterOptions: {
                        mochaFile: 'tests/jsValidator/TEST-index.xml'
                    },
                    colors: true,
                    summery: true,
                    captureFile: 'tests/jsValidator/output.txt', // Optionally capture the reporter output to a file
        ...
        mocha_istanbul: {
            ...
            options: {
                ...
                coverageFolder: "coverage/jsvalidator",
    ...
    grunt.registerTask('jsValidator-voter', [
        'clean:results',
        'mochaTest',
        'mocha_istanbul'
    ]);
